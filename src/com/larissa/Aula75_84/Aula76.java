...
public class Aula76 {
	...
	public static void main(String[] args) {
		...
		concatenacao  +=  "Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. ";
		concatenacao2 += "Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.";
		concatenacao2 += " Excepteur sint occaecat cupidatat non proident, ";
